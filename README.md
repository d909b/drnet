...
Author(s): Patrick Schwab, ETH Zurich <patrick.schwab@hest.ethz.ch>, Lorenz Linhardt, ETH Zurich <llorenz@student.ethz.ch>, Stefan Bauer, MPI for Intelligent Systems <stefan.bauer@tuebingen.mpg.de>, and Walter Karlen, ETH Zurich <walter.karlen@hest.ethz.ch>
...
- Navigate to the directory containing this file.
- Create a folder to hold the experimental results `mkdir -p results`.
- Run `python ./drnet/apps/run_all_experiments.py ./drnet/apps news_matching_percentage ./data ./results`
...
- Navigate to the directory containing this file.
- Create a folder to hold the experimental results `mkdir -p results`.
- Run `python ./drnet/apps/run_all_experiments.py ./drnet/apps news_treatment_assignment ./data ./results`
